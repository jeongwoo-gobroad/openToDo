...
plnit_clientCore.o: plnit_clientCore.h plnit_clientCore.c
	gcc -Wall -c -g plnit_clientCore.h plnit_clientCore.c

plnit_dbcore.o: plnit_dbAPI.h plnit_cliAPI.h plnit_dbCore.h plnit_dbCore.c
	gcc -Wall -c -g plnit_dbAPI.h plnit_cliAPI.h plnit_dbCore.h plnit_dbCore.c

plnit_uxCore.o: plnit_dbAPI.h plnit_uxCore.h plnit_uxCore.c
	gcc -Wall -c -g plnit_dbAPI.h plnit_uxCore.h plnit_uxCore.c



refresh:
	rm pln plnit_dbCore.o plnit_uxCore.o plnit_clientCore.o plnit_dbAPI.h.gch plnit_clientCore.h.gch plnit_uxCore.h.gch

cleanup:
	rm plnit_dbCore.o plnit_uxCore.o plnit_clientCore.o plnit_dbAPI.h.gch plnit_clientCore.h.gch plnit_uxCore.h.gch